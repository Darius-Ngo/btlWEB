<?php
    ...
    $sql_prod = "select * from category";
    $cate_all = mysqli_query($conn,$sql_prod);
        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Danh sách danh mục món</h2>
                    ...
                    <div class="col-lg-2 col-sm-6  mb-2">
                        ...
                        <div class="portfolio-item">
                            ...
                            <!-- <a class="portfolio-link" data-bs-toggle="modal" href="#">
                                ...
                                <img class="img-fluid" src="../../admin/product/uploads/<?php echo $value['image'] ?>" alt="" />
                            </a>
