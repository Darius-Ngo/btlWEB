...
<html lang="en">
    <head>
        ...
        <link href="http://localhost:8080/Web-Food/access/php/giohang-donhang/assets/css/style.css" rel="stylesheet" />
    </head>
    <body id="page-top">
        ...
        <section class="page-section bg-light" id="portfolio">
                ...
                <div class="row" id="list-food">
                    ...
                    if(mysqli_num_rows($result) > 0) {
                        while($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<script>';
                            echo 'var food = {product_id: '.$row['ID'].', name: "'.$row['name'].'", price: '.$row['price'].', image: "'.$row['image'].'", distance: "'.$row['distance'].'", content: "'.$row['content'].'"};';
                            ...
                            //             </div>
                            //             <img class="img-fluid" src="assets/img/'.$row['anh'].'" alt="..." />
                            //         </a>
                            //         <div class="portfolio-caption">
                            //             <div class="portfolio-caption-heading">'.$row['ten_mon'].'</div>
                            //             <div class="portfolio-caption-subheading text-muted">'.number_format($row['gia_ban']).'đ</div>
                            //             <div class="portfolio-caption-subheading text-muted">'.$row['khoang_cach'].'km</div>
                            //             <button type="button" class="btn btn-warning" style=";margin-left:auto;margin-right:auto;display:block;margin-top:0%;margin-bottom:0%">Chọn mua</button>
                            //         </div>
                            //     </div>
                            // </div>';
                        }
         ...
         <!-- Portfolio Modals-->
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <div class="modal-body">
                                        ...
                                        <p></p>
                                        <button onclick="location.href="detail.php?ID=${value.id} class="btn btn-primary btn-xl text-uppercase" data-bs-dismiss="modal" type="button">
            ...
            <button type="button" onclick="location.href='http://localhost/TEST/indexall.php';" class="btn btn-info" style=";margin-left:auto;margin-right:auto;display:block;margin-top:0%;margin-bottom:0%" >Xem tất cả --></button>
            </div>
